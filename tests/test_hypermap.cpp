...
int main (int argc, char ** argv) {
	...
	// Hypermap M { {{1},{5},{7},{9},{2,8,0},{4,3,6}}, {{2,1},{0,3},{4,5},{6,7},{8,9}}, {{2,1,0,4,5,6,7,3,8,9}} };	// Graph H - use n=4 - TODO rotate
	...
	Hypermap M = {	{{0,7,8},{1,10,2},{3,12,4},{5,14,6},{9,23,16},{11,17,18},{13,19,20},{15,21,22}},
	              	...
	              	{{0,2,4,6},{1,8,16,11},{3,10,18,13},{5,12,20,15},{7,14,22,9},{17,23,21,19}} }; // Cube - n=3 FAIL
