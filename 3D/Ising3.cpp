...
int main (int argc, char ** argv) {
	CL_Parser CLP (argc, argv, "n=50,b=1,t=0,p=.5,k,c=bernoulli|cube|dobrushin|hexagon|step,s=0,m,i");
	...
	if (CLP('i')) for (auto c = C.begin(); c != C.end(); ++c) C.put(c, (c.y>C.sy/2) ? C.at(c)/2 : C.at(c));
