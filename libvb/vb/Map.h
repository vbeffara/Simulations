...
namespace vb {
	using Edge = std::pair<int,int>;     ///< A simple alias for map edges.
	using adj_list = std::vector<int>; ///< A simple alias for adjacency lists.
	...
	class Map : public Picture {
		public:
			 ...
			 *
			 * @return The energy of the final configuration.
			 */
			 ...
			 *
			 * @return The value of the cost-function in the final state.
			 */
