...
PRNG::PRNG (long aa, long bb, long mm) : max(mm), a(aa), b(bb) {
...
void PRNG::iterate (long long aa, long long bb, long long n) {
  while (n>0) {
...
void PRNG::srand (long seed) {
  rdmbuf = seed;
}

void PRNG::rewind (long time1, long time2) {
