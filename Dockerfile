...
RUN apt-get install -y libcairo2-dev libfltk1.3-dev libfplll-dev libgmp-dev libmpfr-dev
RUN apt-get install -y libcln-dev libgsl-dev libeigen3-dev libpng++-dev
